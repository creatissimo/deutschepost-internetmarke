...
class CheckoutShoppingCartPDFAppRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'dpi' => 'string',
        'page_format_id' => 'int',
        'positions' => '\DPInternetmarke\Client\Model\AppShoppingCartPDFPosition[]',
        'product_code' => 'int',
        'image_id' => 'int',
    ...
    */
    ...
    public function setShopOrderId($shop_order_id)
    {
        ...
        if ((mb_strlen($shop_order_id) > 18)) {
            throw new \InvalidArgumentException('invalid length for $shop_order_id when calling CheckoutShoppingCartPDFAppRequest., must be smaller than or equal to 18.');
        }
        if ((mb_strlen($shop_order_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shop_order_id when calling CheckoutShoppingCartPDFAppRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets positions
     *
     * @return \DPInternetmarke\Client\Model\AppShoppingCartPDFPosition[]
     */
     ...
     * Sets positions
     *
     * @param \DPInternetmarke\Client\Model\AppShoppingCartPDFPosition[] $positions List of PDF order items. At least one item has to be specified.
     *
     * @return self
     */
