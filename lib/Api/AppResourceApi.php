...
namespace DPInternetmarke\Client\Api;
...
use DPInternetmarke\Client\FormDataProcessor;
use DPInternetmarke\Client\HeaderSelector;
...
class AppResourceApi
{
     ...
     *
     * @throws \DPInternetmarke\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DPInternetmarke\Client\Model\ChargeWalletResponse|\DPInternetmarke\Client\Model\Error400Response|\DPInternetmarke\Client\Model\Error401Response|\DPInternetmarke\Client\Model\Error403Response|\DPInternetmarke\Client\Model\Error404Response|\DPInternetmarke\Client\Model\Error429Response|\DPInternetmarke\Client\Model\Error500Response
     */
     ...
     * @throws \DPInternetmarke\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \DPInternetmarke\Client\Model\ChargeWalletResponse|\DPInternetmarke\Client\Model\Error400Response|\DPInternetmarke\Client\Model\Error401Response|\DPInternetmarke\Client\Model\Error403Response|\DPInternetmarke\Client\Model\Error404Response|\DPInternetmarke\Client\Model\Error429Response|\DPInternetmarke\Client\Model\Error500Response, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\DPInternetmarke\Client\Model\ChargeWalletResponse',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\DPInternetmarke\Client\Model\Error400Response',
                        $request,
                        $response,
                    );
                case 401:
                    return $this->handleResponseWithDataType(
                        '\DPInternetmarke\Client\Model\Error401Response',
                        $request,
                        $response,
                    );
                case 403:
                    return $this->handleResponseWithDataType(
                        '\DPInternetmarke\Client\Model\Error403Response',
                        $request,
                        $response,
                    );
                case 404:
                    return $this->handleResponseWithDataType(
                        '\DPInternetmarke\Client\Model\Error404Response',
                        $request,
                        $response,
                    );
                case 429:
                    return $this->handleResponseWithDataType(
                        '\DPInternetmarke\Client\Model\Error429Response',
                        $request,
                        $response,
                    );
                case 500:
                    return $this->handleResponseWithDataType(
                        '\DPInternetmarke\Client\Model\Error500Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\DPInternetmarke\Client\Model\ChargeWalletResponse';
        $request = $this->chargeWalletRequest($amount, $contentType);
     ...
     *
     * @param  \DPInternetmarke\Client\Model\CheckoutShoppingCartPDFAppRequest $checkout_shopping_cart_pdf_app_request checkout_shopping_cart_pdf_app_request (required)
     ...
     * @param  bool|null $direct_checkout This request parameter enables the direct checkout of the shopping cart and an addition request for the checkout is not required. (optional, default to false)
     ...
     * @throws \DPInternetmarke\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DPInternetmarke\Client\Model\CheckoutShoppingCartAppResponse|\DPInternetmarke\Client\Model\Error400Response|\DPInternetmarke\Client\Model\Error401Response|\DPInternetmarke\Client\Model\Error403Response|\DPInternetmarke\Client\Model\Error429Response|\DPInternetmarke\Client\Model\Error500Response
     */
     ...
     * Checkouts the PDF shopping cart. Be aware of the different types of schemas for checkout OR preview within the request. Preview does not need addresses.
     *
     * @param  \DPInternetmarke\Client\Model\CheckoutShoppingCartPDFAppRequest $checkout_shopping_cart_pdf_app_request (required)
     * @param  bool|null $validate This request parameter enables the validate (preview) case.&lt;br/&gt;The response will contain the link to a preview image of an internet stamp in PDF format. A product code, a layout format and optionally a motif are transferred to the service. This information is encoded in the link and evaluated by INTERNETMARKE when the preview image is rendered. If the product code, print format, or theme ID is invalid, the response to the caller will contain appropriate information.   &lt;br/&gt;&lt;br/&gt; For the validate (preview) case the request body has to be of the specified type (See &#x60;#/components/schemas/AppShoppingCartPreviewPDFRequest&#x60;). (optional, default to false)
     * @param  bool|null $direct_checkout This request parameter enables the direct checkout of the shopping cart and an addition request for the checkout is not required. (optional, default to false)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['checkoutShoppingCartPDFApp'] to see the possible values for this operation
     *
     * @throws \DPInternetmarke\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \DPInternetmarke\Client\Model\CheckoutShoppingCartAppResponse|\DPInternetmarke\Client\Model\Error400Response|\DPInternetmarke\Client\Model\Error401Response|\DPInternetmarke\Client\Model\Error403Response|\DPInternetmarke\Client\Model\Error429Response|\DPInternetmarke\Client\Model\Error500Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function checkoutShoppingCartPDFAppWithHttpInfo($checkout_shopping_cart_pdf_app_request, $validate = false, $direct_checkout = false, string $contentType = self::contentTypes['checkoutShoppingCartPDFApp'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\DPInternetmarke\Client\Model\CheckoutShoppingCartAppResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\DPInternetmarke\Client\Model\CheckoutShoppingCartAppResponse';
        $request = $this->checkoutShoppingCartPDFAppRequest($checkout_shopping_cart_pdf_app_request, $validate, $direct_checkout, $contentType);
     ...
     *
     * @param  \DPInternetmarke\Client\Model\CheckoutShoppingCartPNGAppRequest $checkout_shopping_cart_png_app_request checkout_shopping_cart_png_app_request (required)
     ...
     * @param  bool|null $direct_checkout This request parameter enables the direct checkout of the shopping cart and an extra checkout request is not required. (optional, default to false)
     ...
     * Checkouts the PNG shopping cart. Be aware of the different types of schemas for checkout OR preview within the request. Preview does not need addresses. The print format is not relevant at this point.
     *
     * @param  \DPInternetmarke\Client\Model\CheckoutShoppingCartPNGAppRequest $checkout_shopping_cart_png_app_request (required)
     * @param  bool|null $validate The response will contain the link to a thumbnail image of an Internet brand in PNG format, which the third-party application must integrate accordingly. The print format is not relevant at this point. The service is given a product code, optionally a motif and a layout format. This information is encoded in the link and evaluated by INTERNETMARKE when the preview image is rendered. If the product code or theme ID is invalid, the response to the caller will contain appropriate information. (optional, default to false)
     * @param  bool|null $direct_checkout This request parameter enables the direct checkout of the shopping cart and an extra checkout request is not required. (optional, default to false)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['checkoutShoppingCartPNGApp'] to see the possible values for this operation
     *
     ...
     * @throws \DPInternetmarke\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DPInternetmarke\Client\Model\InitShoppingCartResponse|\DPInternetmarke\Client\Model\Error400Response|\DPInternetmarke\Client\Model\Error401Response|\DPInternetmarke\Client\Model\Error403Response|\DPInternetmarke\Client\Model\Error404Response|\DPInternetmarke\Client\Model\Error429Response|\DPInternetmarke\Client\Model\Error500Response
     */
    ...
    public function initShoppingCartAppWithHttpInfo(string $contentType = self::contentTypes['initShoppingCartApp'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\DPInternetmarke\Client\Model\InitShoppingCartResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\DPInternetmarke\Client\Model\InitShoppingCartResponse';
        $request = $this->initShoppingCartAppRequest($contentType);
     ...
     *
     * @param  \DPInternetmarke\Client\Model\RetoureVouchersRequest $retoure_vouchers_request retoure_vouchers_request (required)
     ...
     * @throws \DPInternetmarke\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DPInternetmarke\Client\Model\RetoureVouchersResponse|\DPInternetmarke\Client\Model\Error400Response|\DPInternetmarke\Client\Model\Error401Response|\DPInternetmarke\Client\Model\Error403Response|\DPInternetmarke\Client\Model\Error429Response|\DPInternetmarke\Client\Model\Error500Response
     */
     ...
     * Request retoure for ordered items corresponding to all items for shopOrderId or items with specific voucherId or trackId
     *
     * @param  \DPInternetmarke\Client\Model\RetoureVouchersRequest $retoure_vouchers_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retoureVouchersApp'] to see the possible values for this operation
     *
     * @throws \DPInternetmarke\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \DPInternetmarke\Client\Model\RetoureVouchersResponse|\DPInternetmarke\Client\Model\Error400Response|\DPInternetmarke\Client\Model\Error401Response|\DPInternetmarke\Client\Model\Error403Response|\DPInternetmarke\Client\Model\Error429Response|\DPInternetmarke\Client\Model\Error500Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function retoureVouchersAppWithHttpInfo($retoure_vouchers_request, string $contentType = self::contentTypes['retoureVouchersApp'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\DPInternetmarke\Client\Model\RetoureVouchersResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\DPInternetmarke\Client\Model\RetoureVouchersResponse';
        $request = $this->retoureVouchersAppRequest($retoure_vouchers_request, $contentType);
     ...
     * @throws \DPInternetmarke\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DPInternetmarke\Client\Model\RetrieveCatalogResponse|\DPInternetmarke\Client\Model\Error400Response|\DPInternetmarke\Client\Model\Error401Response|\DPInternetmarke\Client\Model\Error403Response|\DPInternetmarke\Client\Model\Error404Response|\DPInternetmarke\Client\Model\Error429Response|\DPInternetmarke\Client\Model\Error500Response
     */
    ...
    public function retrieveCatalogAppWithHttpInfo($types, string $contentType = self::contentTypes['retrieveCatalogApp'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\DPInternetmarke\Client\Model\RetrieveCatalogResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\DPInternetmarke\Client\Model\RetrieveCatalogResponse';
        $request = $this->retrieveCatalogAppRequest($types, $contentType);
     ...
     * @throws \DPInternetmarke\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DPInternetmarke\Client\Model\RetrieveRetoureStateResponse|\DPInternetmarke\Client\Model\Error400Response|\DPInternetmarke\Client\Model\Error401Response|\DPInternetmarke\Client\Model\Error403Response|\DPInternetmarke\Client\Model\Error429Response|\DPInternetmarke\Client\Model\Error500Response
     */
     ...
     * @throws \DPInternetmarke\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \DPInternetmarke\Client\Model\RetrieveRetoureStateResponse|\DPInternetmarke\Client\Model\Error400Response|\DPInternetmarke\Client\Model\Error401Response|\DPInternetmarke\Client\Model\Error403Response|\DPInternetmarke\Client\Model\Error429Response|\DPInternetmarke\Client\Model\Error500Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveRetoureStateAppWithHttpInfo($shop_retoure_id = null, $retoure_transaction_id = null, $start_date = null, $end_date = null, string $contentType = self::contentTypes['retrieveRetoureStateApp'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\DPInternetmarke\Client\Model\RetrieveRetoureStateResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\DPInternetmarke\Client\Model\RetrieveRetoureStateResponse';
        $request = $this->retrieveRetoureStateAppRequest($shop_retoure_id, $retoure_transaction_id, $start_date, $end_date, $contentType);
