...
**address** | [**\DPInternetmarke\Client\Model\AddressBinding**](AddressBinding.md) |  | [optional]
**voucher_layout** | **string** |  |
**position_type** | **string** |  |
**position** | [**\DPInternetmarke\Client\Model\VoucherPosition**](VoucherPosition.md) |  |
